...
class FFModel(BaseModel):
    ...
    def define_forward_pass(self):
        ...
        obs_normalized = normalize(self.obs_pl, self.obs_mean_pl, self.obs_std_pl)# TODO(Q1) Define obs_normalized using obs_unnormalized,and self.obs_mean_pl and self.obs_std_pl
        acs_normalized = normalize(self.acs_pl, self.acs_mean_pl, self.acs_std_pl)# TODO(Q2) Define acs_normalized using acs_unnormalized and self.acs_mean_pl and self.acs_std_pl
